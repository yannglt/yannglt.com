      ...
      <div class="container">
        <div class="projectsWrapper">
          <article class="project">
            ...
            <a href="https://www.notion.so/yannglt/Ind-pendants-co-56e64ca3f3074b6590cfcbc3ce598080" title="" target="_blank"  rel="noopener" class="link wip">Work in progress<svg class="icon" aria-hidden="true" focusable="false"><use xlink:href="icons/sprite.svg#auto-renew-16"></use></svg></a>
          </article>
          <article class="project">
            <div class="project-cover"></div>
          ...
          <article class="project">
            ...
            <a href="https://www.notion.so/yannglt/BNP-Paribas-6a9a5a47e47547dfb687ba66b571326b" title="" target="_blank"  rel="noopener" class="link nda">Project under NDA<svg class="icon" aria-hidden="true" focusable="false"><use xlink:href="icons/sprite.svg#block-16"></use></svg></a>
          </article>
        </div>
      </div>
    </section>
